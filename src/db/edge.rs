                                                        ...
                                                        select 
                                                            *,
                                                            case
                                                                ...
                                                                when tags->>'cycleway' = 'lane' then 1 / 0.70
                                                                when tags->>'cycleway:both' = 'lane' then 1 / 0.70
                                                                when tags->>'cycleway:left' = 'lane' then 1 / 0.70
                                                                when tags->>'cycleway:right' = 'lane' then 1 / 0.70
                                                                when tags->>'cycleway:both' = 'shared_lane' then 1 / 0.60
                                                                when tags->>'cycleway:left' = 'shared_lane' then 1 / 0.60
                                                                when tags->>'cycleway:right' = 'shared_lane' then 1 / 0.60
                                                                when tags->>'cycleway' = 'shared_lane' then 1 / 0.60
                                                                when tags->>'highway' = 'residential' then 1 / 0.50
                                                                when tags->>'highway' = 'tertiary' then 1 / 0.45
                                                                when tags->>'highway' = 'secondary' then 1 / 0.35
                                                                when tags->>'highway' = 'service' then 1 / 0.25
