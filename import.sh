                                    ...
                                    create materialized view _all_way_edge as
                                        select 
                                            ...
                                            case
                                                ...
                                                when tags->>'bicycle' = 'designated' then 1 / 0.8
                                                ...
                                                when tags->>'cycleway' = 'shared_lane' then 1 / 0.7
                                                when tags->>'highway' = 'residential' then 1 / 0.7
                                                when tags->>'bicycle' = 'yes' then 1 / 0.7
                                                when tags->>'highway' = 'tertiary' then 1 / 0.6
                                                when tags->>'highway' = 'tertiary_link' then 1 / 0.6
